 ...
 */
export async function imagesCreateImageVariation(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.CreateImageVariationRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/images/variations")();
