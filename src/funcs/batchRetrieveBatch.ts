 ...
 * Retrieves a batch.
 */
export async function batchRetrieveBatch(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RetrieveBatchRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/batches/{batch_id}")(pathParams);
