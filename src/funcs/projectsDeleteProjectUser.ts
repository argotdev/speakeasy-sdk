 ...
 */
export async function projectsDeleteProjectUser(
  client: ArgotOpenAiCore,
  request: operations.DeleteProjectUserRequest,
  options?: RequestOptions,
): Promise<
  Result<
    components.ProjectUserDeleteResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteProjectUserRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ProjectUserDeleteResponse$inboundSchema),
