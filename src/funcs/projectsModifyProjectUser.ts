 ...
 */
export async function projectsModifyProjectUser(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ModifyProjectUserRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ProjectUserUpdateRequest, {
    explode: true,
  });
