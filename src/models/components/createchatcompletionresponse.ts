 ...
 * The service tier used for processing the request. This field is only included if the `service_tier` parameter is specified in the request.
 */
export type CreateChatCompletionResponseServiceTier = ClosedEnum<
  typeof CreateChatCompletionResponseServiceTier
>;
...
export type CreateChatCompletionResponse = {
   ...
   * The service tier used for processing the request. This field is only included if the `service_tier` parameter is specified in the request.
   */
  serviceTier?: CreateChatCompletionResponseServiceTier | null | undefined;
  /**
...
/** @internal */
export const CreateChatCompletionResponseServiceTier$inboundSchema:
  z.ZodNativeEnum<typeof CreateChatCompletionResponseServiceTier> = z
    .nativeEnum(CreateChatCompletionResponseServiceTier);

/** @internal */
export const CreateChatCompletionResponseServiceTier$outboundSchema:
  z.ZodNativeEnum<typeof CreateChatCompletionResponseServiceTier> =
    CreateChatCompletionResponseServiceTier$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace CreateChatCompletionResponseServiceTier$ {
  /** @deprecated use `CreateChatCompletionResponseServiceTier$inboundSchema` instead. */
  export const inboundSchema =
    CreateChatCompletionResponseServiceTier$inboundSchema;
  /** @deprecated use `CreateChatCompletionResponseServiceTier$outboundSchema` instead. */
  export const outboundSchema =
    CreateChatCompletionResponseServiceTier$outboundSchema;
}
